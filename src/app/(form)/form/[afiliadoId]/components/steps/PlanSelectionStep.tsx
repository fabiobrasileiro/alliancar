    ...
    return (
        <div className="space-y-6">
            <div className="bg-white border border-gray-200 rounded-lg p-6">
                ...
                {/* Serviços Incluídos */}
                <div className="mb-8">
                    <p className="text-gray-700 mb-4 text-lg">Este plano inclui:</p>
                    <ul className="space-y-3">
                        <li className="flex justify-between items-center py-3 border-b">
                            ...
                            <div className="text-green-600 font-semibold">Incluído</div>
                        </li>
                        <li className="flex justify-between items-center py-3 border-b">
                            <div className="flex items-center">
                                <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-3">
                                ...
                                <span className="text-gray-700 font-medium">Rastreador</span>
                            </div>
                            <div className="text-green-600 font-semibold">Incluído</div>
                        </li>
                    </ul>
                ...
                <div className="border-t pt-6">
                    <div className="flex justify-between items-center mb-6">
                        <h3 className="text-xl font-bold text-gray-800">Serviços Opcionais inclusos</h3>
                    </div>
                    
                    <p className="text-gray-700 mb-6">Acrescente serviços Opcionais inclusos ao seu plano</p>
