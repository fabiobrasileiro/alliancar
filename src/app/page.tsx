    ...
    noticias: [
      {
        ...
        imagem:
          "https://site.powercrm.com.br/wp-content/uploads/2022/05/thumbnails-360x300-webhook.png",
      ...
      },
      {
        ...
        imagem:
          "https://site.powercrm.com.br/wp-content/uploads/2023/06/Inserir-um-titulo-3.png",
        ...
        <div className="w-full lg:w-2/5">
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h3 className="text-xl font-bold text-gray-800 mb-5">
              Novidades do Power CRM
            </h3>
            <div className="space-y-5">
              {dashboardData.noticias
                .slice(0, showAllNews ? dashboardData.noticias.length : 6)
                .map((noticia) => (
                  <div
                    key={noticia.id}
